        ...
        <footer className="border-t-8 border-t-yellow-500 bg-neutral-900 mt-auto w-full">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-3 text-sm font-medium sm:mb-0 dark:text-gray-400">
                        <li>
                            <a href="/about" className="text-gray-500 hover:underline me-4 md:me-6">About</a>
                        </li>
                        <li>
                            <a href="/contact" className="text-gray-500 hover:underline me-4 md:me-6">Contact</a>
                        </li>
                        <li>
                            <a href="/portfolio" className="text-gray-500 hover:underline">Portfolio</a>
                        </li>
                    </ul>
                </div>
                <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline text-yellow-500">Krewe Live</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
